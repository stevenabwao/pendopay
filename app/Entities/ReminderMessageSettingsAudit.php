...
class ReminderMessageSettingsAudit extends Model
{

    protected $table = "reminder_message_settings_audits";

    /**
     * The attributes that are mass assignable
    **/
    protected $fillable = [
        'id', 'parent_id', 'company_id', 'status_id', 'reminder_message_type_id', 'reminder_message_type_section_id', 'product_id', 
    ...
    /*start relationships*/
    public function remindermessagesetting()
    {
        return $this->belongsTo(ReminderMessageSetting::class, 'parent_id', 'id');
    }
