...
class SupervisorClientAssignAudit extends Model
{


    protected $table = "supervisor_client_assign_audits";

    /**
     * The attributes that are mass assignable
    **/
    protected $fillable = [
         'id', 'parent_id', 'company_supervisor_id', 'company_id', 'created_by', 'updated_by', 
    ...
    {
        return $this->belongsTo(SupervisorClientAssign::class, 'parent_id', 'id');
    }
