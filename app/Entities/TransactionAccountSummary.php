...
class TransactionAccountSummary extends BaseModel
{

    protected $dates = ['last_activity_date', 'last_deposit_date', 'last_withdrawal_date'];

    protected $table = 'transaction_account_summary';

    /**
     * The attributes that are mass assignable
    **/
    protected $fillable = [
         'parent_id', 'account_no', 'currency_id', 'ledger_balance', 'cleared_balance', 'last_activity_date',
    ...
    {
        return $this->hasOne(TransactionAccount::class, 'account_no', 'account_no');
    }

    public function transactionaccounthistory()
    {
