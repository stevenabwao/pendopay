...
use App\Services\LoanApplication\LoanApplicationUpdate;
...
class ApiLoanApplicationController extends BaseController
{
    ...
    */
     ...
     * @return mixed
    */
    public function update(Request $request, $id, LoanApplicationApprove $loanApplicationApprove)
    {
     ...
     */
     public function requestUpdate(Request $request, LoanApplicationUpdate $loanApplicationUpdate)
     {
