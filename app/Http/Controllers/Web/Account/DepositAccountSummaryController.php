...
class DepositAccountSummaryController extends Controller
{
    ...
    /**
     * DepositAccountSummaryController constructor.
     *
     ...
     */
    public function index(Request $request, DepositAccountSummaryIndex $depositAccountSummaryIndex)
    {
        ...
        $data = $depositAccountSummaryIndex->getData($request);
        ...
        return view('accounts.deposit-accounts.deposit-accounts-summary.index', [
            'depositaccountssummary' => $data->appends(Input::except('page')),
            'companies' => $companies
        ]);
    ...
    public function show($id)
    {
        ...
        $depositaccountsummary = $this->model->find($id);
        
        return view('accounts.deposit-accounts.deposit-accounts-summary.show', compact('depositaccountsummary'));
