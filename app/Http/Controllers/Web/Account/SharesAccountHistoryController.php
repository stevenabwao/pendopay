...
use App\Services\SharesAccountHistory\SharesAccountHistoryIndex;
use App\User;
use Carbon\Carbon;
use Excel;
...
class SharesAccountHistoryController extends Controller
{
    ...
    /**
     * SharesAccountHistoryController constructor.
     *
     * @param SharesAccountHistory $model
     */
    public function __construct(SharesAccountHistory $model)
    {
        $this->model = $model;
     ...
     */
    public function index(Request $request, SharesAccountHistoryIndex $sharesAccountHistoryIndex)
    {

        //get the data
        $companies = getAllUserCompanies($request);

        $data = $sharesAccountHistoryIndex->getData($request);
        ...
        //dd($data);
            ...
            return view('accounts.shares-accounts.shares-accounts-history.index', [
                'sharesaccountshistory' => $data->appends(Input::except('page')),
                'companies' => $companies
            ]);
    ...
    public function show($id)
    {
        ...
        //return view('accounts.shares-accounts.savings.show', compact('account'));
        return view('accounts.shares-accounts.shares-accounts-history.show', [
            'sharesaccounthistory' => $account
        ]);
