...
class BranchMemberController extends Controller
{
    ...
    public function index(Request $request, BranchMemberIndex $branchMemberIndex)
    {
        ...
        if (isUserHasPermissions("1", ['read-company-branch-member'])) {
    ...
    public function create()
    {
        ...
        if (isUserHasPermissions("1", ['create-company-branch-member'])) {
    ...
    public function edit($id)
    {
        ...
        if (isUserHasPermissions("1", ['update-company-branch-member'])) {
