...
class AssetIndex
{
	...
	public function getData($request)
	{
        ...
        $id = $request->id;
        $ussd_event_map_id = $request->ussd_event_map_id;
        ...
        if ($ussd_event_map_id) {
            $data = $data->where('ussd_event_map_id', $ussd_event_map_id);
        }
        if ($asset_type_id) {
            $data = $data->where('asset_type_id', $asset_type_id);
        }
        if ($mime) {
            $data = $data->where('mime', $mime);
        }
        if ($companies) {
