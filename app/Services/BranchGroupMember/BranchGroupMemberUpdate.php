...
namespace App\Services\BranchGroupMember;
...
class BranchGroupMemberUpdate 
{
    ...
    public function updateItem($id, $attributes) {
        ...
        $company_branch_data = BranchGroupMember::where('id', $id)->first();
        ...
        if ($company_branch_data) {
            ...
            */
            ...
            try {
                ...
                $new_company_branch = new BranchGroupMember();
                ...
                $result = $new_company_branch->updatedata($id, $attributes);
