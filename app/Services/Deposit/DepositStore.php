...
class DepositStore
{
    ...
    public function createItem($attributes) {
        ...
        DB::beginTransaction();
            ...
            $barddy_company_id = getBarddyCompanyId();

            //get the ref account no
            $dep_account_data = DepositAccount::where('phone', $phone)->first();
            ...
            if (!$deposit_account_summary_data) {
                ...
                $deposit_account_summary_attributes['company_id'] = $barddy_company_id;
            ...
            try {
                ...
                if ($deposit_account_summary_data) {
                    ...
                    $deposit_account_history_attributes['company_id'] = $barddy_company_id;
