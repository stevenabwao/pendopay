...
class GlAccountSummaryToExcel
{
	...
	public function exportExcel($type, $data) {
        ...
        //get the data
        $accountIndex = new GlAccountSummaryIndex();
        ...
        if (count($accounts)) {
            ...
            foreach ($accounts as $account) {
                ...
                $account_obj = new GlAccountSummary($account);
                //dd($account_obj);
        ...
        $excel_name = "gl_accounts_summary";
        $excel_title = "GL Accounts Summary";
        $excel_desc = "GL Accounts Summary";
