...
class LoanApplicationStore
{
    ...
    public function createItem($attributes) {
        ...
        try {
            ...
            log_this($message . "<br> No deposit account summary record found. Loan Application Id -" . $loan_application->id);
        ...
        $user_set_loan_limit, $one_month_limit, $one_to_three_month_limit, $three_to_six_month_limit, $above_six_month_limit);
        ...
        DB::beginTransaction();
            ...
            //start if auto approval method is set, proceed
            if ($loan_approval_method == 'auto') {
                ...
                $message = "Loan application has been created. Please wait as it is being processed";
                log_this($message);
