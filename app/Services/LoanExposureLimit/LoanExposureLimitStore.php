...
use App\Entities\LoanExposureLimitDecline;
use App\Services\LoanExposureLimit\LoanExposureLimitCheck;
use Carbon\Carbon;
use Illuminate\Support\Facades\DB;

class LoanExposureLimitStore
{
    ...
    public function createItem($attributes) {
        ...
        try {
            ...
            $loan_application = new LoanExposureLimit();

            $new_loan_application = $loan_application->create($attributes);

            //store audits
            storeLoanExposureLimitAudit($new_loan_application->id);
        ...
        if ($new_loan_application) {
            ...
            try {
                ...
                $loan_application_check = new LoanExposureLimitCheck();
