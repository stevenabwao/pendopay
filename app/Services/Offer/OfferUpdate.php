...
class OfferUpdate
{
    ...
    public function updateItem($id, $request) {
        ...
        $start_at = createDateFromFormat($start_at, $date_format);
        $end_at = createDateFromFormat($end_at, $date_format);
        ...
        if ($request->hasFile('item_image')) {
            ...
            // set imagetabletype
            $offer_image_table_type = config('constants.imagetabletypes.offer_image');
            ...
            $caption = $name;
            $image_section = $offer_image_table_type;
