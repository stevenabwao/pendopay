...
class PaymentTransactionTransferStore
{
    ...
    public function createItem($attributes, $new_payment) {
        ...
        DB::beginTransaction();
            ...
            try{
                ...
                $paymentTransactionStore = new PaymentTransactionStore();

                //replace amount with new amount
                $payment_transaction_attributes['amount'] = $amount;
                $payment_transaction_attributes['account_no'] = $account_no;
                $payment_transaction_attributes['source_account_no'] = $source_account_no;
                $payment_transaction_attributes['destination_account_no'] = $destination_account_no;
                $payment_transaction_attributes['phone'] = $phone_number;
                $payment_transaction_attributes['phone_number'] = $phone_number;
                $payment_transaction_attributes['mpesa_code'] = "";
                $payment_transaction_attributes['payment_id'] = $payment_id;
                $payment_transaction_attributes['payment_method_id'] = $payment_method_id;
                $payment_transaction_attributes['full_name'] = $full_name;
                $payment_transaction_attributes['transfer'] = "1";
                $payment_transaction_attributes['tran_ref_txt'] = $tran_ref_txt;
                $payment_transaction_attributes['tran_desc'] = $tran_desc;
                // dd($payment_transaction_attributes);

                $payment_transaction_result = $paymentTransactionStore->createItem($payment_id, $payment_transaction_attributes);
                log_this("\n\n\n************** PAYMENT STORE ************* \n\n" . json_encode($payment_transaction_result)
                    . "\n\n*******************************************\n\n");
