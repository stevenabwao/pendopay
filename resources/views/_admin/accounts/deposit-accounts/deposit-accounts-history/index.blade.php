...
@section('title')
    ...
    Manage Deposit Account History
...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <h5 class="txt-dark">
                Manage Deposit Accounts History
            </h5>
          </div>
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('deposit-accounts-history') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                          ...
                          <div>
                            ...
                            <form action="{{ route('deposit-accounts-history.index') }}">
                                        ...
                                        @if (count($depositaccountshistory))
                                            <div class="btn-group">
                                                <div class="dropdown">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('excel.deposit-accounts-history',
                                                                    ['xls',
                                                    ...
                                                    <li><a href="{{ route('excel.deposit-accounts-history',
                                                                    ['csv',
                                                                    'start_date' => app('request')->input('start_date'),
                                                                    'end_date' => app('request')->input('end_date'),
                                                                    'account_search' => app('request')->input('account_search'),
