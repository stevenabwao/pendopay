...
@section('title')
    ...
    Manage Deposit Accounts Summary
...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('deposit-accounts-summary') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                          ...
                          <div>
                            ...
                            <form action="{{ route('deposit-accounts-summary.index') }}">
                                 ...
                                 <tr>
                                  ...
                                  <td>
                                    ...
                                    <div class="pull-left col-sm-12 col-sm-6 col-md-2">
                                      ...
                                      @if (count($depositaccountssummary))
                                          <div class="btn-group">
                                              <div class="dropdown">
                                                  <button
                                                  aria-expanded="false"
                                  ...
                                  <div class="table-responsive">
                                     <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($depositaccountssummary as $depaccountsummary)
                                             <tr>

                                                <td>
                                                  <span class="txt-dark">
                                                    {{ $depaccountsummary->id }}
                                                  </span>
                                                </td>

                                                <td>
                                                    @if ($depaccountsummary->status->id != 1)
                                                      <span class="txt-dark text-danger">
                                                          {{ $depaccountsummary->account_no }}
                                                      </span>
                                                    @else
                                                      <span class="txt-dark">
                                                          {{ $depaccountsummary->account_no }}
                                                ...
                                                <td>
                                                  <span class="txt-dark">
                                                        @if ($depaccountsummary->depositaccount)
                                                             {{ titlecase($depaccountsummary->depositaccount->account_name) }}
                                                        @endif
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                    <span class="txt-dark">
                                                          {{ $depaccountsummary->phone }}
                                                    </span>
                                                </td>

                                                <td>
                                                  <span class="txt-dark">
                                                        @if ($depaccountsummary->company)
                                                            {{ titlecase($depaccountsummary->company->name) }}
                                                        @endif
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                    <span class="txt-dark">
                                                     {{ formatFriendlyDate($depaccountsummary->last_deposit_date) }}
                                                    </span>
                                                 </td>

                                                <td align="right">
                                                  <span class="txt-dark">
                                                    {{ format_num($depaccountsummary->ledger_balance) }}
                                                  </span>
                                                </td>

                                                <td align="right">
                                                    <span class="txt-dark">
                                                      {{ format_num($depaccountsummary->last_deposit_amount) }}
                                                    </span>
                                                  </td>

                                                <td>

                                                   <a href="{{ route('deposit-accounts-summary.show', $depaccountsummary->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i>
                                                   </a>

                                                   {{-- <a href="{{ route('deposit-accounts-summary.edit', $depaccountsummary->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-edit"></i>
                                                   </a> --}}

                                                   {{-- <a href="{{ route('deposit-accounts-summary.destroy', $depaccountsummary->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
