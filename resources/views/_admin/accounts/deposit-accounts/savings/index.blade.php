...
@section('title')
    ...
    Manage Savings Deposit Accounts
...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('savings-deposit-accounts') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                                ...
                                <div class="btn-group">
                                    <div class="dropdown">
                                       ...
                                       <ul role="menu" class="dropdown-menu">
                                          ...
                                          <li>
                                            <a href="{{ route('excel.savings-deposit-accounts',
                                                        ['xls',
                                          ...
                                          <li><a href="{{ route('excel.savings-deposit-accounts', 'csv') }}">As CSV</a></li>
                                          <li><a href="{{ route('excel.savings-deposit-accounts', 'pdf') }}">As PDF</a></li>
                          ...
                          <div class="pull-right col-sm-9">
                            ...
                            <form action="{{ route('savings-deposit-accounts.index') }}">
                                           ...
                                           @foreach ($accounts as $account)
                                             <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('savings-deposit-accounts.show', $account->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i>
                                                   </a>

                                                   <a href="{{ route('savings-deposit-accounts.edit', $account->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-edit"></i>
                                                   </a>

                                                   <a href="{{ route('savings-deposit-accounts.destroy', $account->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
