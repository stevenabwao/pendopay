...
@section('title')
    ...
    Showing Savings Deposit Account - {{ $account->account_no }}
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          <div class="col-sm-6 col-xs-12">
            <h5 class="txt-dark">Showing Savings Deposit Account - {{ $account->account_no }}</h5>
          </div>
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('savings-deposit-accounts.show', $account->account_no) !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
              ...
              <div  class="panel-wrapper collapse in">
                 ...
                 <div  class="panel-body pb-0 ml-20 mr-20 mb-20">
                    ...
                    <div class="social-info">
                      ...
                      <a
                          href="{{ route('savings-deposit-accounts.edit', $account->id) }}"
            ...
            <div class="panel panel-default card-view pa-0 equalheight">
              ...
              <div  class="panel-wrapper collapse in">
                 ...
                 <div  class="panel-body pb-0 ml-20 mr-20 mb-20">
                      ...
                      <p class="mb-20">
                          <h5><strong>Savings Deposit Account Details</strong></h5>
                      </p>
