...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('gl-accounts-history') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                          ...
                          <div>
                            ...
                            <form action="{{ route('gl-accounts-history.index') }}">
                                      ...
                                      @if (count($glaccountshistory))
                                          <div class="btn-group">
                                              <div class="dropdown">
                                                  ...
                                                  <li>
                                                      <a href="{{ route('excel.gl-accounts-history',
                                                                  ['xls',
                                                  ...
                                                  <li><a href="{{ route('excel.gl-accounts-history',
                                                                  ['csv',
                                                                  'start_date' => app('request')->input('start_date'),
                                                                  'end_date' => app('request')->input('end_date'),
                                                                  'account_search' => app('request')->input('account_search'),
                                  ...
                                  <div class="table-responsive">
                                     <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($glaccountshistory as $glaccounthistory)
                                             <tr>
                                                ...
                                                <td>
                                                  <span class="txt-dark">
                                                        {{ titlecase($glaccounthistory->company_name) }}
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('gl-accounts-history.show', $glaccounthistory->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i>
                                                   </a>

                                                   {{-- <a href="{{ route('gl-accounts-history.edit', $glaccounthistory->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-edit"></i>
                                                   </a> --}}

                                                   {{-- <a href="{{ route('gl-accounts-history.destroy', $glaccounthistory->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
