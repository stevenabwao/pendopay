...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('gl-accounts-summary') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                                ...
                                <div class="btn-group">
                                    <div class="dropdown">
                                       ...
                                       <ul role="menu" class="dropdown-menu">
                                          ...
                                          <li>
                                            <a href="{{ route('excel.gl-accounts-summary',
                                                        ['xls',
                                          ...
                                          <li><a href="{{ route('excel.gl-accounts-summary', 'csv') }}">As CSV</a></li>
                                          <li><a href="{{ route('excel.gl-accounts-summary', 'pdf') }}">As PDF</a></li>
                          ...
                          <div class="pull-right col-sm-9">
                            ...
                            <form action="{{ route('gl-accounts-summary.index') }}">
                                  ...
                                  <div class="table-responsive">
                                     <table class="table table-hover mb-0">
                                        <thead>
                                           <tr>
                                              <th width="5%">id</th>
                                              <th width="10%">GL Account No</th>
                                              <th width="20%">Account Name</th>
                                              <th width="20%">Account Type</th>
                                              <th width="15%">Company/ Sacco</th>
                                              <th width="15%">Last Activity Date</th>
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($glaccountssummary as $glaccountsummary)
                                             <tr>
                                                ...
                                                <td>
                                                  <span class="txt-dark">
                                                      @if ($glaccountsummary->company)
                                                        {{ titlecase($glaccountsummary->company->name) }}
                                                      @endif
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('gl-accounts-summary.show', $glaccountsummary->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i>
                                                   </a>

                                                   {{-- <a href="{{ route('gl-accounts-summary.edit', $glaccountsummary->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-edit"></i>
                                                   </a> --}}

                                                   {{-- <a href="{{ route('gl-accounts-summary.destroy', $glaccountsummary->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
