...
@section('page_breadcrumbs')
    ...
    {!! Breadcrumbs::render('admin.establishments.edit', $company->id) !!}
       ...
       <!-- /Title -->
        ...
        <div class="row">
            ...
            <form method="POST" enctype="multipart/form-data"
                action="{{ route('admin.establishments.update', $company->id) }}">
                                                  ...
                                                  <select class="selectpicker form-control"
                                                      ...
                                                      <li class="mb-10">
                                                        <option value="{{ $county->id }}"
                                                          ...
                                                          @if ($county->id == old('county_id', $company->county->id))
                                                                selected="selected"
                                                          @endif
                                                          >
                                                          {{ $county->name }}

                                                          @if(($county->company) && (Auth::user()->hasRole('superadministrator')))
                                                                &nbsp; ({{ $county->company->name }})
                                                          @endif
                                                        </option>
                                                      </li>
                                                  ...
                                                  <select class="selectpicker form-control"
                                                      ...
                                                      <li class="mb-10">
                                                        <option value="{{ $category->id }}"
                                                          ...
                                                          @if ($category->id == old('category_id', $company->category->id))
                                                                selected="selected"
                                                          @endif
                                                          >
                                                          {{ $category->name }}
                                          ...
                                          <div  class="form-group{{ $errors->has('paybill_no') ? ' has-error' : '' }}">
                                              ...
                                              <div class="col-md-7">
                                                <input
                                                    ...
                                                    id="paybill_no"
                                                    name="paybill_no"
                                                    value="{{ old('paybill_no', $company->paybill_no) }}"
                                          ...
                                          <div  class="form-group{{ $errors->has('personal_phone') ? ' has-error' : '' }}">
                                              ...
                                              <div class="col-md-7">
                                                <input
                                                    ...
                                                    id="personal_phone"
                                                    name="personal_phone"
                                                    value="{{ old('personal_phone', $company->personal_phone) }}"
                                          ...
                                          <div  class="form-group{{ $errors->has('personal_email') ? ' has-error' : '' }}">
                                              ...
                                              <div class="col-md-7">
                                                <input
                                                    ...
                                                    id="personal_email"
                                                    name="personal_email"
                                                    value="{{ old('personal_email', $company->personal_email) }}"
                                                  ...
                                                  <select class="selectpicker form-control"
                                                      ...
                                                      <li class="mb-10">
                                                        <option value="{{ $status->id }}"
                                                          ...
                                                          @if ($status->id == old('status_id', $company->status->id))
                                                                selected="selected"
                                                          @endif
                                                          >
                                                          {{ $status->name }}
                              ...
                              <div class="mt-0">
                                  @if(count($company->images))
                                    <input type="file" id="input-file-now-custom-3" class="dropify" data-height="400"
                                      data-default-file="{{ asset($company->images[0]->thumb_img_400) }}" name="item_image"/>
                                  @else
                                    <input type="file" id="input-file-now-custom-3" class="dropify" data-height="400"
                          ...
                          <div class="follo-data">
                            <div class="user-data">
                              <span class="name block">
                                <strong>Establishment Location (point and click on location):</strong>
                                <br><br>
                                <div id="map-canvas" style="min-height:400px;"></div>
                                <br>
                                <input value="{{ old('longitude', $company->longitude) }}"
                                    type="hidden" name="longitude" id="longitude">
                                <input value="{{ old('latitude', $company->latitude) }}"
...
@section('css_header')
    ...
    <link href="{{ asset('_admin/css/maps.css') }}" rel="stylesheet" type="text/css">
