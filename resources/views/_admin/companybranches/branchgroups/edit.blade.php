...
@section('title')
    ...
    Edit Branch Group - {{ $branchgroup->name }}
      ...
      <!-- Title -->
       <div class="row heading-bg">
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">Edit Branch Group - {{ $branchgroup->name }}</h5>
          </div>
          <!-- Breadcrumb -->
          <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
              {!! Breadcrumbs::render('branchgroups.edit', $branchgroup->id) !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                              ...
                              <div class="panel-body">
                                 ...
                                 <div class="form-wrap">
                                    ...
                                    <form class="form-horizontal" method="POST"
                                        action="{{ route('branchgroups.update', $branchgroup->id) }}">
                                       ...
                                       <div  class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                          ...
                                          <div class="col-sm-9">
                                            <input
                                                ...
                                                id="name"
                                                name="name"
                                                value="{{ old('name', $branchgroup->name)}}"
                                                required
                                                autofocus>
                                       ...
                                       <div  class="form-group{{ $errors->has('company_branch_id') ? ' has-error' : '' }}">
                                            ...
                                            @if ($company_branch->id == old('company_branch_id', $branchgroup->id))
                                                selected="selected"
                                            @endif
                                                        >
                                                        {{ $company_branch->name }}
                                       ...
                                       <div  class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                          ...
                                          <div class="col-sm-9">
                                            ...
                                            <textarea
                                                ...
                                                rows="5"
                                                id="description"
                                                name="description">{{ old('description', $branchgroup->description)}}</textarea>
                                       ...
                                       <div  class="form-group{{ $errors->has('primary_user_id') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @foreach ($branchgroupusers as $user)
                                                <li class="mb-10">
                                                <option value="{{ $user->id }}"
                                            @if ($user->id == old('primary_user_id', $branchgroup->primary_user_id))
                                                selected="selected"
                                            @endif
                                                    >
                                                    ...
                                                    <div class="col-sm-5 no-padding-right">
                                                        <select id="phone_country" name="phone_country" class="form-control selectpicker" required>
                                                            ...
                                                            @foreach ($countries as $country)
                                                                ...
                                                                @if ($country->sortname == old('phone_country', $branchgroup->phone_country))
                                                                    selected="selected"
                                                                @endif
                                                                    >
                                       ...
                                       <div  class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                          ...
                                          <div class="col-sm-9">
                                            <input
                                                ...
                                                id="email"
                                                name="email"
                                                value="{{ old('email', $branchgroup->email)}}">
                                       ...
                                       <div  class="form-group{{ $errors->has('physical_address') ? ' has-error' : '' }}">
                                          ...
                                          <div class="col-sm-9">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('physical_address', $branchgroup->physical_address)}}">
