    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            if( $('#chart_orders').length > 0 ){
                var ctx6 = document.getElementById("chart_orders").getContext("2d");
                var data6 = {
                    labels: [
                    "Active Orders",
                    "Pending Orders"
                ...
                datasets: [
                    {
                        data: [{{ $activeorderscount }},{{ $pendingorderscount }}],
                        backgroundColor: [
                            "#fec107",
                            "#ff2a00",
        ...
        var sparklineLogin = function() { 
            if( $('#sparkline_active').length > 0 ){
                $("#sparkline_active").sparkline([2,4,4,6,8,5,6,4,8,6,6,2 ], {
                    type: 'line',
                    width: '100%',
                    height: '35',
                    lineColor: '#2879ff',
            ...
            //show overdue loans
            if( $('#sparkline_pending').length > 0 ){
                $("#sparkline_pending").sparkline([0,2,8,6,8], {
                    type: 'line',
                    width: '100%',
                    height: '35',
                    lineColor: '#2879ff',
