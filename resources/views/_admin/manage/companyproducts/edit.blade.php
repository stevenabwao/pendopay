...
@section('title')
    ...
    Edit Company Product - {{ $companyproduct->id }} - {{ $companyproduct->name }}
      ...
      <!-- Title -->
       <div class="row heading-bg">
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">Edit Company Product - {{ $companyproduct->id }}</h5>
          </div>
          <!-- Breadcrumb -->
          <div class="col-lg-8 col-sm-8 col-md-8 col-xs-12">
              {!! Breadcrumbs::render('companyproducts.edit', $companyproduct->id) !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                              ...
                              <div class="panel-body">
                                 ...
                                 <div class="mb-30">
                                    <h3 class="text-center txt-dark mb-10">
                                        Edit Company Product - {{ $companyproduct->name }}
                                    </h3>
                                 </div>
                                 ...
                                 <div class="form-wrap">
                                    ...
                                    <form class="form-horizontal" method="POST"
                                        action="{{ route('companyproducts.update', $companyproduct->id) }}">
                                       ...
                                       <div  class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                          ...
                                          <div class="col-sm-9">
                                            <input
                                                ...
                                                id="name"
                                                name="name"
                                                value="{{ old('name', $companyproduct->name)}}"
                                                required
                                                autofocus>
                                       ...
                                       <div  class="form-group{{ $errors->has('product_id') ? ' has-error' : '' }}">
                                            ...
                                            @if ($product->id == old('product_id', $companyproduct->product->id))
                                                selected="selected"
                                            @endif
                                                    >
                                                        {{ $product->name }}
                                       ...
                                       <div  class="form-group{{ $errors->has('company_id') ? ' has-error' : '' }}">
                                            ...
                                            @if ($company->id == old('company_id', $companyproduct->company->id))
                                                selected="selected"
                                            @endif
                                                    >
                                                        {{ $company->name }}
