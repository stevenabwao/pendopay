...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('companyproducts') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                                           ...
                                           @foreach ($companyproducts as $companyproduct)
                                             <tr>
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('companyproducts.show', $companyproduct->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i>
                                                   </a>

                                                   <a href="{{ route('companyproducts.edit', $companyproduct->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
