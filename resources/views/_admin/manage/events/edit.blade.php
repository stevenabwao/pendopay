...
@section('title')
    ...
    Edit Event - {{ $event->id }} - {{ $event->name }}
      ...
      <!-- Title -->
       <div class="row heading-bg">
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">Edit Event - {{ $event->id }}</h5>
          </div>
          <!-- Breadcrumb -->
          <div class="col-lg-8 col-sm-8 col-md-8 col-xs-12">
              {!! Breadcrumbs::render('events.edit', $event->id) !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                                    ...
                                    <form class="form-horizontal" method="POST"
                                       ...
                                       <div  class="form-group{{ $errors->has('event_cd') ? ' has-error' : '' }}">
                                          ...
                                          <label for="event_cd" class="col-sm-3 control-label">
                                             ...
                                             <span class="text-danger"> *</span>
                                             &nbsp;&nbsp;
                                             <a href="#" title="Unique numeric event identifier e.g. LNC" data-toggle="tooltip" class="ml-10">
                                          ...
                                          <div class="col-sm-9">
                                            <input
                                                ...
                                                id="event_cd"
                                                name="event_cd"
                                                value="{{ old('event_cd', $event->event_cd)}}"
                                                required>
                                       ...
                                       <div  class="form-group{{ $errors->has('status_id') ? ' has-error' : '' }}">
                                          ...
                                          @if ($status->id == old('status_id', $event->status->id))
                                              selected="selected"
                                          @endif
                                                    >
                                                      {{ $status->name }}
