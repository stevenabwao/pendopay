                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                  <span class="txt-dark
                                                   ...
                                                   @if (($glaccount->status->id == 2)
                                                         || ($glaccount->status->id == 3)
                                                         || ($glaccount->status->id == 7)
                                                         || ($glaccount->status->id == 99))
                                                      text-danger
                                                   @endif
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('glaccounts.show', $glaccount->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i>
                                                   </a>

                                                   <a href="{{ route('glaccounts.edit', $glaccount->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
