                                        ...
                                        <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div  class="form-group{{ $errors->has('one_month_limit') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    value="{{ old('one_month_limit', $loansetting->one_month_limit)}}">
                                            ...
                                            <div  class="form-group{{ $errors->has('one_to_three_month_limit') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    value="{{ old('one_to_three_month_limit', $loansetting->one_to_three_month_limit)}}">
                                            ...
                                            <div  class="form-group{{ $errors->has('three_to_six_month_limit') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    value="{{ old('three_to_six_month_limit', $loansetting->three_to_six_month_limit)}}">
                                            ...
                                            <div  class="form-group{{ $errors->has('above_six_month_limit') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    value="{{ old('above_six_month_limit', $loansetting->above_six_month_limit)}}">
