...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('remindersettings') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                          ...
                          <div class="pull-right col-sm-9">
                            ...
                            <form action="{{ route('remindersettings.index') }}">
                                  ...
                                  <div class="table-responsive">
                                     <table class="table table-hover mb-0">
                                        <thead>
                                           <tr>
                                              <th width="5%">id</th>
                                              <th width="20%">Reminder Type</th>
                                              <th width="20%">Reminder Section</th>
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($remindersettings as $remindersetting)
                                             <tr>
                                                ...
                                                <td>
                                                  <span class="txt-dark">
                                                    ...
                                                    @if ($remindersetting->remindermessagetype)
                                                      {{ $remindersetting->remindermessagetype->name }}
                                                    @endif
                                                ...
                                                <td>
                                                  <span class="txt-dark">
                                                    @if ($remindersetting->remindermessagetypesection)
                                                      {{ $remindersetting->remindermessagetypesection->name }}
                                                    @endif
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                  <span class="txt-dark">
                                                    @if ($remindersetting->company)
                                                    {{ $remindersetting->company->name }}
                                                    @endif
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                  <span class="txt-dark
                                                      ...
                                                      @if ($remindersetting->status_id != 1)
                                                          text-danger
                                                      @else
                                                          text-success
                                                      @endif
                                                ...
                                                <td>
                                                   <span class="txt-dark">
                                                    {{ formatFriendlyDate($remindersetting->created_at) }}
                                                   </span>
                                                </td>

                                                <td>

                                                   <a href="{{ route('remindersettings.show', $remindersetting->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i>
                                                   </a>

                                                   <a href="{{ route('remindersettings.edit', $remindersetting->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
