...
@section('title')
    ...
    Showing Reminder Settings - {{ $remindersetting->remindermessagetypesection->name }}
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          <div class="col-sm-6 col-xs-12">
            <h5 class="txt-dark">Showing Reminder Settings - {{ $remindersetting->remindermessagetypesection->name }}</h5>
          </div>
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('remindersettings.show', $remindersetting->id) !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                                      ...
                                      <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                                          ...
                                          <hr>
                                            ...
                                            <div  class="form-group{{ $errors->has('status_id') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="radio">
                                                        <input type="radio" disabled name="status_id" id="status_id" value="1"
                                                        @if(old('status_id', $remindersetting->status_id)=="1") checked @endif>
                                                        <label for="1">Enable Reminder</label>
                                                    </div>
                                                    <div class="radio">
                                                        <input type="radio" disabled name="status_id" id="status_id" value="99"
                                            ...
                                            @if ($remindersetting->reminder_message_type_section_id == config('constants.reminder_type_sections.almost_expiring_loans'))
                                                ...
                                                <div  class="form-group{{ $errors->has('reminder_message_send_to_expiry_cycle_id') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select class="form-control" name="reminder_message_send_to_expiry_cycle_id" disabled>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        value="{{ $remindersetting->reminder_message_send_to_expiry_value }}" disabled>
                                                    </div>
                                                    <div class="col-sm-3">
                                            ...
                                            @if ($remindersetting->reminder_message_type_section_id == config('constants.reminder_type_sections.active_loans'))
                                                ...
                                                <div  class="form-group{{ $errors->has('reminder_message_send_on_each_schedule') ? ' has-error' : '' }}">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select class="form-control" name="reminder_message_send_on_each_schedule" disabled>
                                                                    @foreach ($terms as $term)
                                                                        <li class="mb-10">
                                                                        <option value="{{ $term->id }}"
                                          ...
                                          @if (($remindersetting->reminder_message_type_section_id == config('constants.reminder_type_sections.almost_expiring_loans')) ||
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                <input type="text" name="max_reminder_messages" class="form-control digitsOnly" value="{{ $remindersetting->max_reminder_messages }}" disabled>
                                                </div>
                                                <div class="col-sm-3">
                                          ...
                                          @if ($remindersetting->reminder_message_type_section_id == config('constants.reminder_type_sections.active_loans'))
                                            ...
                                            <div  class="form-group{{ $errors->has('reminder_message_send_repeat_schedule') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="radio">
                                                        <input type="radio" name="reminder_message_send_repeat_schedule" id="all" value="decline" disabled
                                                    ...
                                                    <div class="radio">
                                                        <input type="radio" name="reminder_message_send_repeat_schedule" id="first_last" value="queue" disabled
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-sm-6">
                                                  ...
                                                  <div class="checkbox checkbox-primary">
                                                        ...
                                                        @if($remindersetting->send_sms=="1") checked @endif disabled>
                                                        <label for="send_sms">
                                                                Sms
                                                        </label>
                                                  </div>
                                                  <div class="checkbox checkbox-primary">
                                                        ...
                                                        @if($remindersetting->send_email=="1") checked @endif disabled>
                                          ...
                                          <div class="box-footer">
                                            <a href="{{ route('remindersettings.edit', $remindersetting->id) }}" class="btn btn-primary pull-right">
