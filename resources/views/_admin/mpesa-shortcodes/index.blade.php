...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('mpesa-shortcodes') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                          ...
                          <div class="pull-left col-sm-4">
                              ...
                              <a
                                href="{{ route('mpesa-shortcodes.create') }}"
                          ...
                          <div class="pull-right col-sm-8">
                            ...
                            <form action="{{ route('mpesa-shortcodes.index') }}">
                                  ...
                                  <div class="table-responsive">
                                     <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($mpesashortcodes as $mpesashortcode)
                                             <tr>
                                                ...
                                                <td>
                                                  <span class="txt-dark">
                                                    {{ $mpesashortcode->shortcode_number }}
                                                  </span>
                                                </td>

                                                <td>
                                                  <span class="txt-dark">
                                                    {{ $mpesashortcode->status->name }}
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                  <span class="txt-dark">
                                                    @if ($mpesashortcode->company)
                                                      {{ $mpesashortcode->company->name }}
                                                    @endif
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                   <span class="txt-dark">
                                                   {{ formatFriendlyDate($mpesashortcode->created_at) }}
                                                   </span>
                                                </td>

                                                <td>

                                                   <a href="{{ route('mpesa-shortcodes.show', $mpesashortcode->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i>
                                                   </a>

                                                   @if (Auth::user()->hasRole('superadministrator'))
                                                     <a href="{{ route('mpesa-shortcodes.edit', $mpesashortcode->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                        <i class="zmdi zmdi-edit"></i>
                                                     </a>
                                                   @endif

                                                   @if (Auth::user()->hasRole('superadministrator'))
                                                     <a href="{{ route('mpesa-shortcodes.destroy', $mpesashortcode->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
