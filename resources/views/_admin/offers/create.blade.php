...
@section('page_breadcrumbs')
    {!! Breadcrumbs::render('admin.offers.create') !!}
 @endsection
                                             ...
                                             <div  class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-8">
                                                   <input
                                                      ...
                                                      id="name"
                                                      name="name"
                                                      value="{{ old('name', 'Kilimanjaro Day') }}"
                                                      required
                                                      autofocus>
                                             ...
                                             <div  class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                                ...
                                                <div class="col-md-8">
                                                   <textarea name="description" id="description" rows="3"
                                                      class="form-control">{{ old('description', 'Kilimanjaro Day') }}</textarea>
                                                ...
                                                <div class="col-md-8">
                                                   ...
                                                   <select class="selectpicker form-control"
                                                         ...
                                                         <option value="{{ $company->id }}"
                                                            ...
                                                            @if ($company->id == old('company_id', '635'))
                                                                  selected="selected"
                                                            @endif
                                                            >
                                                            {{ $company->name }}
