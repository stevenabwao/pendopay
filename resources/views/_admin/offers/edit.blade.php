 ...
 @section('title')
    Edit Offer - {{ $offer->id }} - {{ $offer->name }}
 @endsection

 @section('page_breadcrumbs')
    {!! Breadcrumbs::render('admin.offers.edit', $offer->id) !!}
 @endsection
...
<div class="container-fluid">
    ...
    <div class="row heading-bg">
        ...
        <div class="col-sm-6 col-xs-12">
            <h5 class="txt-dark">Edit Offer - {{ $offer->id }} - {{ $offer->name }}</h5>
        </div>
    ...
    <div class="row">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.offers.update', $offer->id) }}">
                            ...
                            <div class="profile-box">
                                ...
                                <div class="social-info">
                                                    ...
                                                    <div class="follo-body">
                                                            ...
                                                            <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <textarea name="description" id="description" rows="3"
                                                                        class="form-control">{{ old("description", $offer->description) }}
                                                                    </textarea>
                                                      ...
                                                      <strong>{{ $errors->first('description') }}</strong>
                                                                    ...
                                                                    data-style="form-control btn-default btn-outline" required>
                                                                        ...
                                                                        <li class="mb-10">
                                                                            <option value="{{ $company->id }}"
                                                                                @if ($company->id == old("company_id", $offer->company_id))
                                                                                selected="selected"
                                                                                @endif >
                                                               ...
                                                               <div class="col-md-8">
                                                                  ...
                                                                  <select class="selectpicker form-control"
                                                                        ...
                                                                        <option value="{{ $status->id }}"
                                                                           ...
                                                                           @if ($status->id == old('status_id', $offer->status_id))
                                                                                 selected="selected"
                                                                           @endif
                                                                           >
                                                                           {{ $status->name }}
                                                            ...
                                                            <div class="form-group{{ $errors->has('offer_type') ? ' has-error' : '' }}">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <div class="radio no-margin">
                                                                        ...
                                                                        {{ $offer->offer_type=="regular" ? 'checked' : '' }}
                                                                        v-model="offer_type" value="regular">
                                                                        <label for="regular">Regular Offer</label>
                                                                    </div>
                                                                    <div class="radio no-margin">
                                                                        <input type="radio" name="offer_type" value="one-time"
                                                                        {{ $offer->offer_type=="one-time" ? 'checked' : '' }}
                                                                        v-model="offer_type" value="one-time">
                                                        ...
                                                        <div class="follo-data">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <div v-if="offer_type=='regular'">
                                                                        ...
                                                                        <select class="form-control" name="offer_frequency" v-model="offer_frequency">
                                                                            ...
                                                                            <li class="mb-10">
                                                                                <option value="recurring-weekly" @if ($offer->offer_frequency == 'recurring-weekly') selected="selected" @endif >Weekly

                                                                                </option>
                                                                            </li>

                                                                            <li class="mb-10">
                                                                                <option value="recurring-monthly" @if ($offer->offer_frequency == 'recurring-monthly') selected="selected" @endif >Monthly

                                                                                </option>
                                                                            </li>

                                                                            <li class="mb-10">
                                                                                <option value="recurring-yearly" @if ($offer->offer_frequency == 'recurring-yearly') selected="selected" @endif >Yearly
                                                                    ...
                                                                    <select class="form-control" name="offer_frequency"
                                                                        v-if="offer_type=='one-time'">

                                                                        <li class="mb-10">
                                                                            <option value="once" @if ($offer->offer_frequency == 'one-time') selected="selected" @endif >Once
                                                            ...
                                                            <div class="form-group{{ ($errors->has('offer_day')) ? ' has-error' : '' }}" v-if="offer_frequency=='recurring-weekly'">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <div v-if="offer_type=='regular'">
                                                                        ...
                                                                        <select class="form-control" name="offer_day">

                                                                            <li class="mb-10">
                                                                                <option value="monday" @if ($offer->offer_day == 'monday') selected="selected" @endif >Monday

                                                                                </option>
                                                                            </li>

                                                                            <li class="mb-10">
                                                                                <option value="tuesday" @if ($offer->offer_day == 'tuesday') selected="selected" @endif >Tuesday

                                                                                </option>
                                                                            </li>

                                                                            <li class="mb-10">
                                                                                <option value="wednesday" @if ($offer->offer_day == 'wednesday') selected="selected" @endif >Wednesday

                                                                                </option>
                                                                            </li>

                                                                            <li class="mb-10">
                                                                                <option value="thursday" @if ($offer->offer_day == 'thursday') selected="selected" @endif >Thursday

                                                                                </option>
                                                                            </li>

                                                                            <li class="mb-10">
                                                                                <option value="friday" @if ($offer->offer_day == 'friday') selected="selected" @endif >Friday

                                                                                </option>
                                                                            </li>

                                                                            <li class="mb-10">
                                                                                <option value="saturday" @if ($offer->offer_day == 'saturday') selected="selected" @endif >Saturday

                                                                                </option>
                                                                            </li>

                                                                            <li class="mb-10">
                                                                                <option value="sunday" @if ($offer->offer_day == 'sunday') selected="selected" @endif >Sunday
                                                       ...
                                                       {{--  <div class="follo-data">
                                                            ...
                                                            <div class="form-group{{ $errors->has('expiry_at') ? ' has-error' : '' }}">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        id='start_date' name="expiry_at" disabled
                                                                        value="{{ old('expiry_at', $offer->expiry_at) }}" />
                                                            ...
                                                            <div class="form-group{{ $errors->has('start_at') ? ' has-error' : '' }}">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <div class='input-group date' id='start_date_group'>
                                                                        ...
                                                                        <input type='text' class="form-control dateInput" placeholder="Start Date"
                                                                        id='start_date2' name="start_at"
                                                                        value="{{ old('start_at', formatDatePickerDate($offer->start_at)) }}" />
                                                            ...
                                                            <div class="form-group{{ $errors->has('end_at') ? ' has-error' : '' }}">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <div class='input-group date' id='end_date_group'>
                                                                        ...
                                                                        <input type='text' class="form-control dateInput" placeholder="End Date"
                                                                        id='end_date2' name="end_at"
                                                                        value="{{ old('end_at', formatDatePickerDate($offer->end_at)) }}" />
                                                        ...
                                                        <div class="follo-data">
                                                            ...
                                                            <div class="form-group{{ $errors->has('offer_expiry_method') ? ' has-error' : '' }}">
                                                                <label for="offer_expiry_method" class="col-md-4 control-label">Offer Purchase Expiry
                                                                </label>
                                                                <div class="col-md-8">
                                                                    <div class="radio no-margin">
                                                                        <input type="radio" name="offer_expiry_method" value="by_date" {{ $offer->offer_expiry_method=="by_date" ? 'checked' : '' }} v-model="offer_expiry_method" value="by_date">
                                                                        <label for="by_date">By Date</label>
                                                                    </div>
                                                                    <div class="radio no-margin">
                                                                        <input type="radio" name="offer_expiry_method" value="by_sales" {{ $offer->offer_expiry_method=="by_sales" ? 'checked' : '' }} v-model="offer_expiry_method" value="by_sales">
                                    ...
                                    <strong>{{ $errors->first('offer_expiry_method') }}</strong>
                                                            ...
                                                            <div class="form-group{{ $errors->has('by_sales') ? ' has-error' : '' }}" v-if="offer_expiry_method=='by_sales'">
                                                                ...
                                                                <div class="col-md-8 no-gutter">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input type="text" class="form-control" id="max_sales" name="max_sales" value="{{ $offer->max_sales }}"> @if ($errors->has('max_sales'))
                                                                        <span class="help-block">
                                                        ...
                                                        <div class="follo-data">
                                                            ...
                                                            <div class="form-group{{ $errors->has('min_age') ? ' has-error' : '' }}">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <select class="selectpicker form-control" name="min_age" data-style="form-control btn-default btn-outline">
                                                                        ...
                                                                        <li class="mb-10">
                                                                            <option value="{{ $age_range['id'] }}" @if ($age_range[ 'id']==$offer->min_age) selected="selected" @endif > {{ $age_range['age'] }}
                        ...
                        <div class="panel-body pb-0 ml-20 mr-20">
                            ...
                            <div class="panel-wrapper collapse in">
                                <div class="panel-body">
                                    <div class="mt-0">
                                        <input type="file" id="input-file-now-custom-3" class="dropify" data-height="400" data-default-file="" name="item_image" />
                                    </div>
                                </div>
                            </div> --}}
                                  ...
                                  <div class="mt-0">
                                      @if(count($offer->images))
                                        <input type="file" id="input-file-now-custom-3" class="dropify" data-height="400"
                                          data-default-file="{{ asset($offer->images[0]->thumb_img_400) }}"
                                          name="item_image" title="{{ $offer->images[0]->caption }}"/>
                                      @else
                                        <input type="file" id="input-file-now-custom-3" class="dropify" data-height="400"
