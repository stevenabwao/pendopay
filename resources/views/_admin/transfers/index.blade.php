                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                          ...
                          <div>
                            ...
                            <form action="{{ route('transfers.index') }}">
                                        ...
                                        @if (count($transfers))
                                            <div class="btn-group">
                                                <div class="dropdown">
                                                    ...
                                                    <li><a href="{{ route('excel.transfers',
                                                                    ['csv',
                                                                    'start_date' => app('request')->input('start_date'),
                                                                    'end_date' => app('request')->input('end_date'),
                                                                    'account_search' => app('request')->input('account_search'),
                                           ...
                                           @foreach ($transfers as $transfer)
                                             <tr>
                                                ...
                                                <td>
                                                  <span class="txt-dark">
                                                        @if ($transfer->company)
                                                            {{ titlecase($transfer->company->name) }}
                                                        @endif
                                                  </span>
                                                </td>
                                                ...
                                                <td>
                                                   ...
                                                   <a href="{{ route('transfers.show', $transfer->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-eye"></i>
                                                   </a>

                                                   {{-- <a href="{{ route('transfers.edit', $transfer->id) }}" class="btn btn-primary btn-sm btn-icon-anim btn-square">
                                                    <i class="zmdi zmdi-edit"></i>
                                                   </a> --}}

                                                   {{-- <a href="{{ route('transfers.destroy', $transfer->id) }}" class="btn btn-danger btn-sm btn-icon-anim btn-square">
