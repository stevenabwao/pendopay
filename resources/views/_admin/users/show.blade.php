...
@section('title')
    ...
    Displaying User - {{ titlecase($user->first_name) }} {{ titlecase($user->last_name) }}
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          <div class="col-sm-6 col-xs-12">
            <h5 class="txt-dark">Displaying User - {{ titlecase($user->first_name) }} {{ titlecase($user->last_name) }}</h5>
          </div>
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
