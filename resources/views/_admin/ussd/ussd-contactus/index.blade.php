...
@section('content')
    ...
    <div class="container-fluid">
       ...
       <div class="row heading-bg">
          ...
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('ussd-contactus') !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                  ...
                  <div class="panel panel-default card-view panel-refresh">
                       ...
                       <div class="panel-heading panel-heading-dark">
                                ...
                                <div class="btn-group">
                                    <div class="dropdown">
                                       ...
                                       <ul role="menu" class="dropdown-menu">
                                          ...
                                          <li>
                                            <a href="{{ route('excel.ussd-contactus',
                                                        ['xls',
                                          ...
                                          <li><a href="{{ route('excel.ussd-contactus', 'csv') }}">As CSV</a></li>
                                          <li><a href="{{ route('excel.ussd-contactus', 'pdf') }}">As PDF</a></li>
                          ...
                          <div class="pull-right col-sm-9">
                            ...
                            <form action="{{ route('ussd-contactus.index') }}">
                                  ...
                                  <div class="table-responsive">
                                     <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($ussdcontactus as $ussdcontact)
                                             <tr>
                                                ...
                                                <td>
                                                   <span class="txt-dark">
                                                    {{ formatFriendlyDate($ussdcontact->created_at) }}
                                                   </span>
                                                </td>

                                                <td>

                                                   <a href="{{ route('ussd-contactus.show', $ussdcontact->id) }}" class="btn btn-info btn-sm btn-icon-anim btn-square">
